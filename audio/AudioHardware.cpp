...
static uint32_t DEVICE_SPEAKER_CALL_RX       = 62; // speaker_rx
static uint32_t DEVICE_SPEAKER_CALL_TX       = 63; // speaker_call_tx
#ifdef BACK_MIC_CAMCORDER
static uint32_t DEVICE_CAMCORDER_TX          = 105;
#endif
...
#endif
{
    ...
    if (!strcmp("true", value))
        ...
        for(i = 0; i < dev_cnt;i++) {
            ...
            else if((strcmp((char* )name[i],"headset_stereo_rx") == 0) || (strcmp((char* )name[i],"headset_rx") == 0) || (strcmp((char*)name[i],"headset_stereo_rx_playback") == 0)) {
            ...
            else if((strcmp((char* )name[i],"bt_sco_rx") == 0) || (strcmp((char* )name[i],"bt_sco_voip_rx") == 0) || (strcmp((char* )name[i],"bt_sco_bttm_rx") == 0)) {
                index = DEVICE_BT_SCO_RX;
            }
            else if((strcmp((char* )name[i],"bt_sco_tx") == 0) || (strcmp((char* )name[i],"bt_sco_voip_tx") == 0) || (strcmp((char* )name[i],"bt_sco_bttm_tx") == 0)) {
                index = DEVICE_BT_SCO_TX;
            }
            else if((strcmp((char*)name[i],"headset_stereo_speaker_stereo_rx") == 0) || (strcmp((char*)name[i],"headset_speaker_stereo_rx") == 0) || (strcmp((char*)name[i],"speaker_headset_rx") == 0)) {
            ...
            else if((strcmp((char* )name[i], "handset_lgvm_tx") == 0) || (strcmp((char* )name[i], "handset_lgcam_tx") == 0))
